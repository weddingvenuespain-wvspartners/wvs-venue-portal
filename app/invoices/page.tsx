      ...
      <div className="main-layout">
        ...
        <div className="topbar">
          ...
          <div style={{ display: 'flex', gap: 8 }}>
            {tab === 'venue' && (
              <button className="btn btn-primary btn-sm" onClick={() => router.push('/invoices/new')}>
                      ...
                      {filteredVenue.length === 0 && (
                        <tr>
                          <td colSpan={9} style={{ textAlign: 'center', padding: '48px 20px', color: 'var(--warm-gray)' }}>
                            ...
                            <button className="btn btn-primary btn-sm" style={{ marginTop: 12 }} onClick={() => router.push('/invoices/new')}>
                      ...
                      {filteredVenue.map(inv => {
                        ...
                        return (
                          <tr key={inv.id} style={{ cursor: 'pointer' }} onClick={() => router.push(`/invoices/${inv.id}`)}>
                            ...
                            <td>
                              <button className="btn btn-ghost btn-sm" onClick={e => { e.stopPropagation(); router.push(`/invoices/${inv.id}`) }}>
                                <Eye size={12} />
                              </button>
                            </td>
                          </tr>
