          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, marginBottom: 28 }}>
            {[1, 2].map(s => (
              <div key={s} style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                ...
                {s < 2 && (
                  <div style={{ width: 32, height: 1, background: s < step ? 'var(--gold)' : 'var(--ivory)' }} />
                )}
              </div>
            ))}
          </div>
          ...
          <div style={{ background: '#fff', borderRadius: 16, padding: '36px 32px', boxShadow: '0 4px 24px rgba(0,0,0,0.06)' }}>
            ...
            <form onSubmit={handleStep1}>
              ...
              <div style={{ position: 'relative', marginBottom: 20 }}>
                ...
                <input
                  type="text"
                  placeholder="Ej: Hacienda El Olivar"
                  value={venueName}
              ...
              <div style={{ position: 'relative', marginBottom: 28 }}>
                ...
                <select
                  ...
                  style={{
                    width: '100%', padding: '10px 12px 10px 34px', borderRadius: 8,
                    border: '1px solid var(--ivory)', background: 'var(--cream)',
                    fontSize: 14, color: region ? 'var(--charcoal)' : 'var(--warm-gray)',
              ...
              <button
                ...
                style={{
                  ...
                  background: 'var(--charcoal)', color: '#fff', fontSize: 14, fontWeight: 500,
            ...
            <form onSubmit={handleStep2}>
              ...
              <button
                ...
                style={{
                  ...
                  background: 'none', color: 'var(--warm-gray)', fontSize: 13, cursor: 'pointer',
        ...
        {step === 3 && (
          <div style={{ background: '#fff', borderRadius: 16, padding: '40px 32px', boxShadow: '0 4px 24px rgba(0,0,0,0.06)', textAlign: 'center' }}>
            <div style={{
              ...
              background: 'rgba(196,151,90,0.12)', display: 'flex',
              ...
              {[
                ...
                <button
                  ...
                  style={{
                    ...
                    borderRadius: 10, border: '1px solid var(--ivory)', background: 'var(--cream)',
                    cursor: 'pointer', textAlign: 'left', transition: 'all 0.15s',
                    fontFamily: 'Manrope, sans-serif',
                  }}
                >
                  <div style={{
                    width: 36, height: 36, borderRadius: 8, background: 'rgba(196,151,90,0.1)',
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
            ...
            <button
              ...
              style={{
                width: '100%', padding: '12px 0', borderRadius: 8, border: 'none',
                background: 'var(--gold)', color: '#fff', fontSize: 14, fontWeight: 500,
