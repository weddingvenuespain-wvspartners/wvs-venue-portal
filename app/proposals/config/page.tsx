  ...
  if (authLoading || loading) return (
    <div style={{ display: 'flex' }}>
      ...
      <div className="main-layout">
        <div className="topbar"><div className="topbar-title">Propuestas</div></div>
    ...
    <div style={{ display: 'flex', minHeight: '100vh', background: 'var(--cream)' }}>
      ...
      <main className="main-content" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', flex: 1 }}>
        <div style={{ textAlign: 'center', maxWidth: 480, padding: '40px 24px' }}>
          ...
          <div style={{ fontFamily: 'Manrope, sans-serif', fontSize: 22, fontWeight: 500, color: 'var(--espresso)', marginBottom: 12 }}>Propuestas personalizadas</div>
        ...
        <div className="page-content">
          ...
          <div style={{ display: 'flex', gap: 0, borderBottom: '2px solid var(--ivory)', marginBottom: 24 }}>
            <a href="/proposals" style={{
              ...
              <FileText size={15} color="var(--warm-gray)" />
              <span style={{ fontSize: 13 }}>Propuestas</span>
            </a>
            <button style={{
              display: 'flex', alignItems: 'center', gap: 8, padding: '12px 24px',
              ...
              <div style={{ textAlign: 'left' }}>
                <div style={{ fontSize: 13, fontWeight: 600 }}>Configuración</div>
                <div style={{ fontSize: 10, color: 'var(--stone)' }}>Plantilla, secciones y contenido de la propuesta</div>
              </div>
            </button>
          </div>

          {!features.propuestas_web && (
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: 300 }}>
              <div style={{ textAlign: 'center', maxWidth: 440 }}>
                ...
                <div style={{ fontFamily: 'Manrope, sans-serif', fontSize: 22, color: 'var(--espresso)', marginBottom: 10 }}>Configuración web de propuesta</div>
                <div style={{ fontSize: 13, color: 'var(--warm-gray)', lineHeight: 1.7, marginBottom: 20 }}>
                  Diseña plantillas con tu branding, secciones y contenido.<br />
                  Disponible en el plan <strong>Premium</strong>.
                </div>
                <div style={{ fontSize: 12, color: 'var(--warm-gray)' }}>Contacta con tu gestor de cuenta para actualizar tu plan</div>
              </div>
