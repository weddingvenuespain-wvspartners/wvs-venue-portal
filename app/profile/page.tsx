                ...
                <>
                  ...
                  <Section title="Consentimientos" description="Gestiona tus preferencias de privacidad y comunicaciones.">
                    ...
                    <div style={{ paddingTop: 14, display: 'flex', gap: 16 }}>
                      <a href="/privacy" style={{ fontSize: 12, color: 'var(--gold)', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: 4 }}>
                ...
                <>
                  ...
                  <Section title="Recursos útiles">
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 10 }}>
                      {[
                        { icon: <BookOpen size={22} />, label: 'Guía de inicio',    hint: 'Empieza aquí', href: '/guides', available: true },
